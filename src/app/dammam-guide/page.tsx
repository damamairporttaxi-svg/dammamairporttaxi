...
const s: Record<string, React.CSSProperties> = {
  ...
  heroSub: { fontSize: "1.05rem", color: "#ffffff", maxWidth: "750px", lineHeight: "1.7" },
  ...
  attrName: { fontSize: "0.97rem", color: "var(--text-primary)", fontWeight: "700", marginBottom: "0.3rem" },
  ...
  sideTitle: { fontSize: "1rem", color: "var(--text-primary)", fontWeight: "700", marginBottom: "1rem" },
  ...
  sideVal: { color: "var(--text-primary)", fontWeight: "600", textAlign: "right", maxWidth: "55%" },
