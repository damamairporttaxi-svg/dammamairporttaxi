      ...
      <section style={art.wrap}>
        <div className="container">
          ...
          <div style={art.block}>
            ...
            <p style={{ ...art.p, fontWeight: 700, color: "#000000", marginTop: "1.5rem", marginBottom: "0.5rem", fontSize: "0.82rem", textTransform: "uppercase", letterSpacing: "0.06em" }}>
            ...
            {/* GCC cross-border */}
            <p style={{ ...art.p, fontWeight: 700, color: "#000000", marginTop: "1.8rem", marginBottom: "0.5rem", fontSize: "0.82rem", textTransform: "uppercase", letterSpacing: "0.06em" }}>
          ...
          <div style={art.twoCol}>
            ...
            <div style={art.infoBox}>
              <h3 style={{ ...art.infoBoxTitle, color: "#000000" }}>GCC Cross-Border Taxi</h3>
              <p style={art.p}>
              ...
              <Link href="/gcc-border-crossing" style={{ ...art.infoLink, color: "#000000" }}>GCC border crossing guide →</Link>
            </div>
          </div>
          ...
          <div className="art-compare-box" style={art.compareBox}>
            <div style={art.compareSide}>
              ...
              {["Fixed fare — agreed before travel", "Driver waiting at arrivals exit", "Live flight tracking & free delay buffer", "GCC cross-border licensed", "Corporate monthly invoicing", "Wi-Fi · water · USB charging onboard"].map(i => (
                <p key={i} style={art.compareItem}><span style={{ color: "#000000", marginRight: "0.5rem" }}>✓</span>{i}</p>
              ))}
            </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  trustText: { fontSize: "0.85rem", fontWeight: 700, color: "#000000" },
  /* How It Works */
  ...
  stars: { color: "#000000", fontSize: "1.2rem", marginBottom: "1rem", letterSpacing: "2px" },
...
const art: Record<string, React.CSSProperties> = {
  ...
  h3: {
    ...
    borderLeft: "4px solid #000000", paddingLeft: "0.8rem",
    marginBottom: "1.2rem",
  },
  ...
  routePrice: {
    fontSize: "0.88rem", fontWeight: 800, color: "#000000",
  ...
  infoLink: { fontSize: "0.85rem", fontWeight: 700, color: "#000000", textDecoration: "underline" },
  ...
  stepNum: {
    fontSize: "2rem", fontWeight: 800, color: "#000000", lineHeight: 1,
  },
  ...
  compareLabel: {
    ...
    textTransform: "uppercase", color: "#000000", marginBottom: "1.1rem",
  },
