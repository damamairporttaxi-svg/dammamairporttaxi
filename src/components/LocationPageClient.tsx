...
const s: Record<string, React.CSSProperties> = {
  ...
  h1: { fontSize: "clamp(1.8rem,4vw,2.8rem)", fontWeight: 800, color: "#fff", lineHeight: 1.2, maxWidth: "700px" },
  ...
  qStatVal: { fontSize: "0.95rem", fontWeight: 700, color: "#fff" },
  ...
  vehicleName: { fontSize: "0.9rem", color: "#fff" },
  ...
  sidebarTitle: { fontSize: "1rem", fontWeight: 700, color: "#fff", lineHeight: 1.4 },
  sidebarStats: {
  ...
  sidebarStatVal: { fontSize: "0.95rem", fontWeight: 700, color: "#fff" },
