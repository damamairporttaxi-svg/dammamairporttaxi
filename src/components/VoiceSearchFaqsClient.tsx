...
const s: Record<string, React.CSSProperties> = {
  ...
  h1: { fontSize: "clamp(1.8rem,4vw,2.8rem)", fontWeight: 800, color: "#fff", lineHeight: 1.2, maxWidth: "750px" },
  ...
  faqQ: {
    ...
    fontSize: "0.95rem", color: "#fff", fontWeight: 600,
  ...
  ctaH2: { fontSize: "1.5rem", fontWeight: 800, color: "#fff", marginBottom: "0.5rem" },
  ctaP: { color: "rgba(255,255,255,0.85)", marginBottom: "1.5rem" },
